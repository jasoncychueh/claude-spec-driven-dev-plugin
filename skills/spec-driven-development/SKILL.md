...
5. After all groups finish, enter Stage 2 — **note in the Stage 2 dispatch how many groups ran**, since parallel groups are exactly what the reviewer's cross-agent integration checks look for (`checklists.md` §1)
